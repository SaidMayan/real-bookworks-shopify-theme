...
//   var cache = {};
  ...
  function cacheSelectors() {
    cache = {
      ...
      $logoWithOpenNav: $('.general-logo'),
      $mobileNavMenuButton: $('.mobile-nav-menu-button')
    };
  }
  ...
  function openMobileNav() {
    ...
    cache.$logoWithOpenNav.addClass('mobile-nav-open-logo');
    
    cache.$mobileNavMenuButton.addClass('mobile-nav-menu-open');
  ...
  function closeMobileNav() {
    ...
    cache.$logoWithOpenNav.removeClass('mobile-nav-open-logo');
    
    cache.$mobileNavMenuButton.removeClass('mobile-nav-menu-open');
...
//        console.log(song);
      ...
      $('.sc-artwork').css('background-image', "url('" + artworkUrl.replace('-large', '-t300x300') + "')");
